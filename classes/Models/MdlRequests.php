...
#           $nameDonor = "";
    ...
    // *******************************************************************************************************
    // ***
    // *** Return items based on request_id
    // ***

    public static function listDogRequests($criteria)
    {
        return (MdlRequests::listRequests('type_time = ' . MdlRequests::DOG . ' and best_time = ' . $criteria));
    }
